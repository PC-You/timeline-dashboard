...
*v0.5.0 — Heterogeneous data model, column config, developer mode:*
...
- **Custom themes** — User-defined palettes beyond the 12 presets. Accent + heatmap ramp + indicator picker.
  Save/load custom themes with state. Builds on the `indicator` field introduced in v0.4.6 and the Appearance
  & Themes tab introduced in v0.5.0.
